            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="dashboard.php" class="nav-link active d-flex align-items-center"> <i class="bi bi-house-door fs-4"></i></i>
                                <p>
                                    Dashboard
                                </p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="#" class="nav-link d-flex align-items-center"> <i class="bi bi-receipt-cutoff fs-4"></i>
                                <p>
                                   Sell Products
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="add_new_sell.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Add New Sell</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="sell_list.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Sell List</p>
                                    </a> </li>                               
                            </ul>
                        </li>
                        <li class="nav-item"> <a href="#" class="nav-link d-flex align-items-center"> <i class="bi bi-capsule-pill fs-4"></i>
                                <p>
                                   Medicine
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
                            ...
                            <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="add_medicine.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Add New Medicine</p>
                                    </a> </li>
                                    <li class="nav-item"> <a href="medicine_list.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Medicine List</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="category.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Category</p>
                                    </a> </li>
                                    <li class="nav-item"> <a href="unit.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Unit</p>
                                    </a> </li>
                                    <li class="nav-item"> <a href="type_medicine.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Type</p>
                                    </a> </li>
                            </ul>
                        </li>
                        <li class="nav-item"> <a href="#" class="nav-link d-flex align-items-center"> <i class="bi bi-cart4 fs-4"></i>
                                <p>
                                   Purchase
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="add_purchase.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Add Purchase</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="purchase_list.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Purchase List</p>
                                    </a> </li>
                            </ul>
                        </li>
                        <li class="nav-item"> <a href="#" class="nav-link d-flex align-items-center"> <i class="bi bi-person-lines-fill fs-4"></i>
                                <p>
                                   Supplier
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="add_supplier.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Add Supplier</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="add_supplier_list.php" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Supplier List</p>
                                    </a> </li>
                             <li class="nav-item"> <a href="./widgets/info-box.html" class="nav-link d-flex align-items-center"><i class="bi bi-arrow-right-short ms-3"></i>
                                        <p>Supplier Ledger</p>
                                    </a> </li> 
                            </ul>
                        </li>
